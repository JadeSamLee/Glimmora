...
import { eeveeChatbot } from '@/ai/flows/eevee-chatbot';
...
const EeveeChatbot = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setAudioUrl(null);
    try {
      const result = await eeveeChatbot({ query, language });
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader>
        <CardTitle>Ask Eevee</CardTitle>
        <CardDescription>Enter a query to generate a spoken response from our AI assistant.</CardDescription>
      </CardHeader>
